...
// class OfcsTable extends Component {
...
//         loading={this.props.loadingOfcs}
//         fetchPage={this.fetchPage}
//        addPathPrefix="/ofc/ofcs/basic-info"
// viewPathPrefix="/ofc/ofcs"
...
// export default withRouter(connect(mapStateToProps, mapDispatchToProps)(OfcsTable));
...
//     console.log("grade value is ",gradeValue)
...
//   connect(mapStateToProps, mapDispatchToProps)(OfcsTable)
// );
...
class OfcsTable extends Component {
  // Updated logic: only return grade when valid, else undefined
  getGradeFromUrl = () => {
    const { grade } = this.props.match.params;
  ...
  fetchPage = (page, limit = this.props.pagination?.limit || 10) => {
    ...
    this.props.getAgniveers(
      ...
      params.get("course"),
      params.get("armyNo"),
      params.get("tradeId") || getTradeId("Ofc") || getTradeId("OFC"),
      gradeValue,
      this.props.text,
    );
  };
  ...
  render() {
    ...
    return (
      <TradeUsersTable
        title="Personal Details"
        trade="ofcs"
        tradeId={getTradeId("Ofc") || getTradeId("OFC")}
        grade={grade}
        data={agniveers}
        pagination={pagination}
        loading={loadingAgniveers}
